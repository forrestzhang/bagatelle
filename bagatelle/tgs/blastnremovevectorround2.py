...
# blastn -db vector.fa -query removehost_removevector_minscore45.1--1.fa -num_threads 40 -task blastn  -outfmt 6 | awk '{print $1"\t"$7"\t"$8}'  | bedtools sort -i - |  bedtools merge -i - -d 1000 > removed_minscore45.1--1.bed
    ...
    for seqname in fa.keys():
        ...
        if seqname in removeregion:
            ...
            if len(removeregion[seqname]) > 1:
                ...
                (seqname, seqstart, seqend) = removeregion[seqname][0].split('\t')[0:3]
